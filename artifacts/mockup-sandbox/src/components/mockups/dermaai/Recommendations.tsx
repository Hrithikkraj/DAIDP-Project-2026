...
const morningRoutine: Product[] = [
  { step: 1, type: "Cleanser", name: "Gentle Hydrating Cleanser", desc: "Removes overnight impurities without stripping barrier.", image: "product-1.jpg", tags: ["Barrier Safe", "Non-foaming"], budget: "Budget", sensitive: true, recommended: true, reason: "Fragrance-free formula suitable for your moderate acne profile. Maintains your skin's natural pH while gently removing impurities." },
  { step: 2, type: "Treatment", name: "Niacinamide 10% Serum", desc: "Controls sebum and reduces redness around the jawline.", image: "product-6.jpg", tags: ["Soothing", "Pore Control"], budget: "Budget", sensitive: true, recommended: true, reason: "Clinically proven to reduce sebum production by 52% in 8 weeks. Ideal for your jawline inflammation pattern." },
  { step: 3, type: "Protection", name: "Lightweight Mineral SPF 50", desc: "Broad-spectrum protection tailored for acne-prone skin.", image: "product-4.jpg", tags: ["Non-comedogenic", "Matte Finish"], budget: "Premium", sensitive: true, recommended: true, reason: "Zinc oxide base doubles as an anti-inflammatory barrier. Essential for preventing post-inflammatory hyperpigmentation." },
];

const nightRoutine: Product[] = [
  { step: 1, type: "Double Cleanse", name: "Oat Cleansing Balm", desc: "Breaks down SPF and excess sebum gently.", image: "product-3.jpg", tags: ["Emollient", "Fragrance Free"], budget: "Premium", sensitive: true, recommended: true, reason: "Colloidal oat soothes your compromised barrier while emulsifying sunscreen. Avoids disrupting your skin microbiome." },
  { step: 2, type: "Treatment", name: "BHA 2% Liquid Exfoliant", desc: "Unclogs pores and treats moderate acne (Use 3x week).", image: "product-2.jpg", tags: ["Active", "Exfoliant"], budget: "Budget", sensitive: false, recommended: true, reason: "Salicylic acid is oil-soluble — it penetrates into pores to dissolve the debris causing your moderate acne clusters." },
  { step: 3, type: "Moisturizer", name: "Ceramide Repair Cream", desc: "Restores moisture to dehydrated cheek areas.", image: "product-5.jpg", tags: ["Hydrating", "Barrier Repair"], budget: "Premium", sensitive: true, recommended: true, reason: "Ceramide 1, 3 & 6-II complex matches your skin's natural lipid ratio. Directly addresses the dehydration detected on outer cheeks." },
];
