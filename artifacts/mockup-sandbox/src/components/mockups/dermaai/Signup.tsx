        ...
        <Card className="p-6 sm:p-8 border-white/60 bg-white/70 backdrop-blur-xl shadow-xl shadow-slate-200/50 rounded-3xl">
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" placeholder="Sarah Jenkins" className="pl-10 bg-white border-slate-200 focus-visible:ring-primary rounded-xl h-11" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" type="email" placeholder="sarah@example.com" className="pl-10 bg-white border-slate-200 focus-visible:ring-primary rounded-xl h-11" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="password" type="password" placeholder="••••••••" className="pl-10 bg-white border-slate-200 focus-visible:ring-primary rounded-xl h-11" />
                </div>
              </div>
            </div>
            ...
            <p className="text-center text-sm text-slate-500 pt-2">
              Already have an account? <a href="#" className="font-medium text-primary hover:underline">Log in</a>
            </p>
          </form>
        </Card>
      </div>
