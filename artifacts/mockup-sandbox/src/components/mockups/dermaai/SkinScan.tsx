          ...
          <>
            {!imageCaptured ? (
              <Card
                ...
                onDrop={(e) => { e.preventDefault(); setIsDragging(false); setImageCaptured(true); }}
              >
                <CardContent className="p-12 flex flex-col items-center justify-center text-center min-h-[360px]">
                  <div className="flex flex-col items-center space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center pt-2">
                      <Button className="rounded-full px-8 shadow-md bg-primary hover:bg-primary/90 text-primary-foreground w-full sm:w-auto" onClick={() => setImageCaptured(true)} aria-label="Open camera">
                        <Camera className="w-4 h-4 mr-2" aria-hidden />
                        Open Camera
                      </Button>
                      <Button variant="outline" className="rounded-full px-8 bg-white dark:bg-zinc-800 w-full sm:w-auto" onClick={() => setImageCaptured(true)} aria-label="Browse files">
                ...
                {scanState === "idle" && (
                  <Card className="border-slate-100 shadow-sm overflow-hidden bg-white dark:bg-zinc-900 animate-in zoom-in-95 duration-500">
                    <div className="relative aspect-[4/3] bg-slate-100 dark:bg-zinc-800 w-full overflow-hidden">
                      <img src="/__mockup/images/face-sample.jpg" alt="Captured scan preview" className="w-full h-full object-cover object-center" />
                  ...
                  <Card className="border-green-200 bg-green-50 dark:bg-green-950/20 animate-in fade-in zoom-in-95 duration-500">
                    <CardContent className="p-8 flex flex-col items-center text-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-700 dark:text-green-300 mt-1">Your results are ready. AI confidence: 94%</p>
                      </div>
                      <Button className="rounded-full px-8 bg-green-600 hover:bg-green-700 text-white shadow-md group mt-2" aria-label="View analysis results">
                        View Results
